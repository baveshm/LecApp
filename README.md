<div align="center">
    <img src="static/img/icon-32x32.png" alt="LecApp Logo" width="32"/>
</div>
...
<p align="center">
  ...
  <a href="#"><img alt="Docker Build" src="https://github.com/baveshm/LecApp/actions/workflows/docker-publish.yml/badge.svg"></a>
  <a href="#"><img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/learnedmachine/lecapp"></a>
</p>
...
LecApp transforms your audio recordings into organized, searchable, and intelligent notes. Built for privacy-conscious teams and individuals, it runs entirely on your own infrastructure, ensuring your sensitive conversations remain completely private.

<div align="center">
    <img src="docs/assets/images/screenshots/Filters.png" alt="LecApp Main Interface" width="750"/>
</div>
...
**Note:** ASR option requires running `onerahmet/openai-whisper-asr-webservice` container alongside LecApp. See [installation guide](#) for complete setup.

**[View Full Installation Guide →](#)**

## Documentation

Complete documentation is available at **[murtaza-nasir.github.io/lecapp](#)**
...
2.  **Commercial License**
    ...
    For users or organizations who cannot or do not wish to comply with the terms of the AGPLv3 (for example, if you want to integrate LecApp into a proprietary commercial product or service without being obligated to share your modifications under AGPLv3), a separate commercial license is available.

    Please contact **lecapp maintainers** for details on obtaining a commercial license.

**You must choose one of these licenses** under which to use, modify, or distribute this software. If you are using or distributing the software without a commercial license agreement, you must adhere to the terms of the AGPLv3.

## Roadmap

LecApp is in active development. Planned features include a faster way to switch transcription languages on the fly.
